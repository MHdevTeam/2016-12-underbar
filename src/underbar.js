(function() {
  ...
  _.last = function(array, n) {
    return ( n === undefined)? array[array.length-1]: ((n===0)? []: ((n > array.length-1)? array :array.splice(n-1)));
    };
  ...
  _.indexOf = function(array, target){
    ...
    var temp;
    _.each(array, function(value, index){ if(value === target && temp ===undefined){ temp= index;} });
    if(temp !== undefined)
      return temp;
    return -1;
  };
  ...
  _.uniq = function(array) {
    ...
    return  _.filter(array, function(value, index){
        return (!result.includes(value))? result.push(value) + true: false;
       });
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    _.each(collection, function(value, index){ accumulator = iterator(accumulator, value); });
    return accumulator;
  };
  ...
  _.some = function(collection, iterator) {
    ...
    return !_.every(collection, function(value){
      return (iterator=== undefined)? iterator = _.identity :!iterator(value);
    }) 
 };
